...
class VideoEncoder(nn.Module):
    ...
    def __init__(
        ...
        feature_channels = base_channels if base_channels is not None else out_channels
...
class VideoDecoder(nn.Module):
    ...
    def __init__(
        ...
        feature_channels = base_channels if base_channels is not None else in_channels
