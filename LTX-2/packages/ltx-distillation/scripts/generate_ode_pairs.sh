...
TEACHER_CHECKPOINT="${TEACHER_CHECKPOINT:-../../../checkpoints/LTX-2.3-fp8/ltx-2.3-22b-dev-fp8.safetensors}"

# Gemma text encoder
GEMMA_PATH="${GEMMA_PATH:-../../../checkpoints/gemma-3-12b-it-qat-q4_0-unquantized}"

# Prompts file (one prompt per line, generate with pe/batch_enhance.py)
PROMPTS_FILE="${PROMPTS_FILE:-./prompts/benchmark_8.txt}"
